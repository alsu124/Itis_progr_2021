...
Требования по оформлению домашних работ:

1. Код должен быть оформлен с соответсвии с требованиями ниже " Правила оформления Python-кода"
2. Комментаруем код  
...
4. У каждого свое решение, свои идеи по решению. Списывания видны сразу. 
